...
export const AdminHeader: React.FC = () => {
  ...
  return (
    <header className="px-8 py-6 flex justify-between items-center bg-white border-b border-outline-variant sticky top-0 z-10 shadow-sm">
      {/* Search system */}
      <div className="hidden md:flex bg-surface-container-low px-4 py-2.5 rounded-xl items-center gap-3 w-80 border border-outline-variant/30">
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Profile Card & Logout */}
        <div className="flex items-center gap-5 border-l pl-6 border-outline-variant/70">
